  ...
  <div>
    ...
    <div>
      ...
      <el-table :data="tableData" border
        ...
        <el-table-column prop="reportedLoss" label="损坏数量" width="140"></el-table-column>
      ...
      <el-dialog title="添加商品报损" :visible.sync="dialogFormVisible" width="50%">
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
          ...
          <el-form-item label="库存下限" prop="reportedLoss">
            <el-input v-model="ruleForm.reportedLoss"></el-input>
          </el-form-item>
      ...
      <el-dialog title="编辑商品" :visible.sync="dialogFormVisibleEdit" width="50%">
        ...
        <el-form :model="editForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
          ...
          <el-form-item label="商品报损数量" prop="reportedLoss">
            <el-input v-model="editForm.reportedLoss"></el-input>
          </el-form-item>
    ...
    batchDelete() {
      this.$confirm('此操作将永久删除该商品, 是否继续?', '提示', {
        ...
        this.multipleSelection.forEach((res,i) => {
          let url = 'http://localhost:9091/goodsbad/' + res.id + '/delete'
          this.axios.post(url).then((response) => {
...
// 添加商品
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          // alert('submit!');
          let url = 'http://localhost:9091/goodsbad/add-new';
          console.log('url >>>'+url);
          console.log('data >>>');
